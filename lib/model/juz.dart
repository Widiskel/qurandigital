...
class Juz {
  ...
  int? juz;
  String? juzStartSurahNumber;
  String? juzEndSurahNumber;
  String? juzStartInfo;
  String? juzEndInfo;
  int? totalVerses;
  List<Verse>? verses;
  ...
  factory Juz.fromJson(Map<String, dynamic> json) => Juz(
        juz: json["juz"],
        juzStartSurahNumber: json["juzStartSurahNumber"].toString(),
        juzEndSurahNumber: json["juzEndSurahNumber"].toString(),
